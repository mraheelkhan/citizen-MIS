...
@if (\Request::is('admins') or \Request::is('roles')  or \Request::is('category')  or \Request::is('settings/forum') or \Request::is('settings/job') or \Request::is('settings/post') or \Request::is('country')  or \Request::is('province')   or \Request::is('city') or \Request::is('menu') or \Request::is('faults') or \Request::is('devices') or \Request::is('couriers') or \Request::is('modules')  or \Request::is('sites') or \Request::is('complaints') or \Request::is('accessories'))  
@endif
...
@if (\Request::is('profile') or \Request::is('admins/create') or Route::currentRouteName()=='admins.edit' or \Request::is('categories/create') or Route::currentRouteName()=='categories.edit' or Route::currentRouteName()=='customers.edit'   or \Request::is('complaints/create'))
